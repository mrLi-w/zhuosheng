...
//    int n;
    ...
    void setwaterLedControl(int i);
    void setmeasureLedControl(int i);

    void settimeFix(int i);
    void settimeAddFix(int i);
    void settempFix(int i);
    void setloopFix(int i);
    void setjudgeStep(int i);
    void setexplainCode(int i);
    void setcollectValue(int i);
...
//    void setTempFixValue(int);
    ...
    void setWaterLevel4Threshold(int);
